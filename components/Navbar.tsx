      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#about-us" className="text-gray-300 hover:text-primary transition-colors">About Us</Link>
            <Link href="/faq" className="text-gray-300 hover:text-primary transition-colors">FAQ</Link>
            <a href="#features" onClick={(e) => handleHashLink(e, '#features')} className="text-gray-300 hover:text-primary transition-colors">Features</a>
            ...
            <button 
              ...
              className="bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600  shadow-[0_8px_20px_rgba(139,92,246,0.3)] hover:shadow-[0_10px_25px_rgba(139,92,246,0.4)] hover:bg-primary-dark text-white px-6 py-2 rounded-lg transition-colors"
            >
              Contact Us
            </button>
          </div>
        ...
        <div className={`md:hidden ${mobileMenuOpen ? 'block' : 'hidden'} mt-4`}>
          <div className="px-4 pt-2 pb-4 space-y-3">
            ...
            <Link href="/faq" className="block text-gray-300 hover:text-primary transition-colors py-2">FAQ</Link>
            <a href="#features" onClick={(e) => handleHashLink(e, '#features')} className="block text-gray-300 hover:text-primary transition-colors py-2">Features</a>
            ...
            <a href="#pricing" onClick={(e) => handleHashLink(e, '#pricing')} className="text-gray-300 hover:text-primary transition-colors">Pricing</a>
            <a href="#contact" onClick={(e) => handleHashLink(e, '#contact')} className="block text-gray-300 hover:text-primary transition-colors py-2">Contact</a>
          </div>
        </div>
      </div>
    </nav>
